...
import { congratulationsLawyerPromotion, interactionEmail, leadEmailTemplate, otpEmail, passwordResetEmail, welcomeLawyerEmail, welcomeLeadSubmitted } from "./templates/template";
