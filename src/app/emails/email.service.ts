...
import { congratulationsLawyerPromotion, interactionEmail, leadEmailTemplate, otpEmail, passwordResetEmail, publicContactEmail, welcomeLawyerEmail, welcomeLeadSubmitted } from "./templates/template";
