...
router.post('/add', firmAuth(Firm_USER_ROLE.ADMIN, Firm_USER_ROLE.STAFF), staffController.createStaff);
// GET staff list
...
// PUT update staff
router.put('/:staffUserId/update',firmAuth(Firm_USER_ROLE.ADMIN, Firm_USER_ROLE.STAFF), staffController.updateStaff);
