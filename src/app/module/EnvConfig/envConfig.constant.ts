...
export const ENV_CONFIG_METADATA: IEnvConfigMetadata[] = [
    ...
    // Payment - Stripe
    {
        ...
        type: ENV_CONFIG_TYPES.STRING,
        description: 'Stripe secret key (Default)',
        isSensitive: true,
        requiresRestart: false,
    },
    {
    ...
    },
    {
        ...
        group: ENV_CONFIG_GROUPS.PAYMENT,
        type: ENV_CONFIG_TYPES.STRING,
        description: 'Stripe webhook secret (Default)',
        isSensitive: true,
        requiresRestart: false,
    },
    {
        ...
        group: ENV_CONFIG_GROUPS.PAYMENT,
        type: ENV_CONFIG_TYPES.STRING,
        description: 'Stripe webhook secret (LIVE)',
        isSensitive: true,
        requiresRestart: false,
    },
    {
        ...
        group: ENV_CONFIG_GROUPS.PAYMENT,
        type: ENV_CONFIG_TYPES.STRING,
        description: 'Stripe webhook secret (TEST)',
        isSensitive: true,
        requiresRestart: false,
    },
    {
        ...
        group: ENV_CONFIG_GROUPS.PAYMENT,
        type: ENV_CONFIG_TYPES.BOOLEAN,
        description: 'Enable Stripe Live mode (Toggle)',
        isSensitive: false,
        requiresRestart: false,
    },
    {
